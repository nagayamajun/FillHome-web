...
export const OneRoomCard = ({
  room: { id, stay_fee, layout, mansion_room_photos },
  rental_house_id,
}: Props): JSX.Element => {
  return (
    ...
    <Link
      href={
        Routing.roomWithRentalHouse.buildRoute({ rental_house_id, id }).path
      }
      className="flex w-full space-x-4 rounded-lg shadow-md"
    >
